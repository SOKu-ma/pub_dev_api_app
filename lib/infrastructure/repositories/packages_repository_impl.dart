...
import 'package:pub_dev_api_app/infrastructure/dto/packages_dto.dart';
...
class PackagesRepositoryImpl implements PackagesRepository {
  ...
  Future<List<PackagesEntity>> fetchPackagesList() async {
    try {
      ...
      final dto = PackagesDto.fromJson(data);
      return dto.packages.map((pkg) => PackagesEntity(name: pkg.name)).toList();
    } catch (e) {
